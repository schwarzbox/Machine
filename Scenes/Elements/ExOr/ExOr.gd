...
const _on: Texture = preload("res://Scenes/Elements/ExOr/ex_or_on.png")
const _off: Texture = preload("res://Scenes/Elements/ExOr/ex_or_off.png")
const _on_off: Texture = preload("res://Scenes/Elements/ExOr/ex_or_on_off.png")
const _off_on: Texture = preload("res://Scenes/Elements/ExOr/ex_or_off_on.png")
