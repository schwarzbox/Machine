...
const _on: Texture = preload("res://Scenes/Elements/HalfAdder/half_adder_on.png")
const _off: Texture = preload("res://Scenes/Elements/HalfAdder/half_adder_off.png")
const _on_off: Texture = preload("res://Scenes/Elements/HalfAdder/half_adder_on_off.png")
const _off_on: Texture = preload("res://Scenes/Elements/HalfAdder/half_adder_off_on.png")
