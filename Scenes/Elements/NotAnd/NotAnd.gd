...
const _on: Texture = preload("res://Scenes/Elements/NotAnd/not_and_on.png")
const _off: Texture = preload("res://Scenes/Elements/NotAnd/not_and_off.png")
const _on_off: Texture = preload("res://Scenes/Elements/NotAnd/not_and_on_off.png")
const _off_on: Texture = preload("res://Scenes/Elements/NotAnd/not_and_off_on.png")
