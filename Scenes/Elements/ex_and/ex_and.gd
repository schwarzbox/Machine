...
const _on: Texture = preload("res://scenes/elements/ex_and/ex_and_on.png")
const _off: Texture = preload("res://scenes/elements/ex_and/ex_and_off.png")
const _on_off: Texture = preload("res://scenes/elements/ex_and/ex_and_on_off.png")
const _off_on: Texture = preload("res://scenes/elements/ex_and/ex_and_off_on.png")
...
func _ready() -> void:
	self.type = Globals.Elements.EX_AND
