...
const _on: Texture2D = preload("res://scenes/elements/ex_and/ex_and_on.png")
const _off: Texture2D = preload("res://scenes/elements/ex_and/ex_and_off.png")
const _on_off: Texture2D = preload("res://scenes/elements/ex_and/ex_and_on_off.png")
const _off_on: Texture2D = preload("res://scenes/elements/ex_and/ex_and_off_on.png")
