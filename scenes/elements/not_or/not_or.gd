...
const _on: Texture2D = preload("res://scenes/elements/not_or/not_or_on.png")
const _off: Texture2D = preload("res://scenes/elements/not_or/not_or_off.png")
const _on_off: Texture2D = preload("res://scenes/elements/not_or/not_or_on_off.png")
const _off_on: Texture2D = preload("res://scenes/elements/not_or/not_or_off_on.png")
