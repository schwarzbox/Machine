...
const _on: Texture2D = preload("res://scenes/elements/or/or_on.png")
const _off: Texture2D = preload("res://scenes/elements/or/or_off.png")
const _on_off: Texture2D = preload("res://scenes/elements/or/or_on_off.png")
const _off_on: Texture2D = preload("res://scenes/elements/or/or_off_on.png")
