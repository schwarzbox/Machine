...
const _on: Texture2D = preload("res://scenes/elements/power_inverter/power_inverter_on.png")
const _off: Texture2D = preload("res://scenes/elements/power_inverter/power_inverter_off.png")
