...
const _on_off: Texture2D = preload("res://scenes/elements/trigger_front/trigger_front_on_off.png")
const _off_on: Texture2D = preload("res://scenes/elements/trigger_front/trigger_front_off_on.png")
const _on_off_out_mem: Texture2D = preload("res://scenes/elements/trigger_front/trigger_front_on_off_out_mem.png")

const _in_mem: Texture2D = preload("res://scenes/elements/trigger_front/trigger_front_in_mem.png")
...
func _ready() -> void:
	type = Globals.Elements.TRIGGER_FRONT
	add_to_group("Energy")
	super()
